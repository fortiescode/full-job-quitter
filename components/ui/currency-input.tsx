    ...
    return (
      <div className={cn("relative", className)}>
        ...
        <input
          ...
          className={cn(
            "w-full h-12 rounded-xl border border-[rgba(0,0,0,0.08)] bg-[#f8f1de]/50 pl-12 pr-4 text-[#1d1d1f] placeholder:text-[#8a8a8a] focus:outline-none focus:ring-2 focus:ring-[#f5c542]/50",
            className
          )}
        />
      </div>
